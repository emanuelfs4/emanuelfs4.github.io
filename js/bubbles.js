...
function PointCollection() {
    ...
    this.update = function () {
        for (var i = 0; i < this.points.length; i++) {
            ...
            point.targetPos.x = d < 25 ? point.curPos.x - dx : point.originalPos.x;
            point.targetPos.y = d < 25 ? point.curPos.y - dy : point.originalPos.y;
    ...
    this.shake = function () {
        var randomNum = Math.floor(Math.random() * 1) - 2;
        ...
        for (var i = 0; i < this.points.length; i++) {
            ...
            var d = Math.sqrt(dd);
            if (d < 50) {
                this.pointCollectionX = Math.floor(Math.random() * 1) - 2;
                this.pointCollectionY = Math.floor(Math.random() * 1) - 2;
            }
